...
namespace TransitionsPlus {
    ...
    public class TransitionAnimatorEditor : Editor {
        ...
        bool previewInProgress, previewPendingSound, previewAnimatorWasDisabled;
        ...
        void OnEnable() {
            ...
            keepSecondCameraActive = serializedObject.FindProperty("keepSecondCameraActive");
        ...
        public override void OnInspectorGUI() {
            ...
            if (profile.objectReferenceValue != null) {
                ...
                if (fadeToCamera.boolValue) {
                    ...
                    EditorGUILayout.PropertyField(keepSecondCameraActive);
        ...
        void StartPreview() {
            if (!animator.gameObject.activeSelf) {
                ...
                previewAnimatorWasDisabled = true;
            } else {
                animator.UpdateMaterialProperties();
                previewAnimatorWasDisabled = false;
            }

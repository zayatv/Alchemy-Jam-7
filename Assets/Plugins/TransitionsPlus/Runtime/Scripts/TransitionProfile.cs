...
namespace TransitionsPlus {
    ...
    public static class TransitionTypeExtensions {
        ...
        public static bool SupportsNoise(this TransitionType type) {
            return type == TransitionType.Wipe || type == TransitionType.Fade || type == TransitionType.DoubleWipe || type == TransitionType.CrossWipe || type == TransitionType.Burn || type == TransitionType.BurnSquare || type == TransitionType.Tiles || type == TransitionType.Circles || type == TransitionType.CircularWipe || type == TransitionType.Screen || type == TransitionType.DoubleSlide || type == TransitionType.Melt;
        }
        ...
        public static bool SupportsRotation(this TransitionType type) {
            return type == TransitionType.Wipe || type == TransitionType.DoubleWipe || type == TransitionType.CrossWipe || type == TransitionType.BurnSquare || type == TransitionType.Mosaic || type == TransitionType.Spiral || type == TransitionType.Dissolve || type == TransitionType.Tiles || type == TransitionType.Splash || type == TransitionType.SeaWaves || type == TransitionType.CircularWipe || type == TransitionType.Screen || type == TransitionType.Shape || type == TransitionType.Slide || type == TransitionType.DoubleSlide || type == TransitionType.Warp;
        }
        ...
        public static bool SupportsAspectRatio(this TransitionType type) {
            return type == TransitionType.Fade || type == TransitionType.Wipe || type == TransitionType.DoubleWipe || type == TransitionType.CrossWipe || type == TransitionType.Splash || type == TransitionType.Screen || type == TransitionType.Tiles || type == TransitionType.TilesProgressive || type == TransitionType.Shape || type == TransitionType.Circles || type == TransitionType.Mosaic || type == TransitionType.Spiral;
        }
        ...
        public static bool SupportsSpread(this TransitionType type) {
            return type == TransitionType.Mosaic || type == TransitionType.Spiral;
        }

        public static bool SupportsCellsDivisions(this TransitionType type) {
            return type == TransitionType.Mosaic || type == TransitionType.Dissolve || type == TransitionType.Tiles || type == TransitionType.TilesProgressive || type == TransitionType.Circles || type == TransitionType.Spiral;
        }
        ...
        public static bool SupportsContrast(this TransitionType type) {
            return type != TransitionType.Shape && type != TransitionType.Smear && type != TransitionType.Warp && type != TransitionType.Pixelate && type != TransitionType.Slide && type != TransitionType.Melt && type != TransitionType.Cube && type != TransitionType.TilesProgressive && type != TransitionType.Ripple;
        }
        ...
        public static bool RequiresFirstCameraCapture(this TransitionType type) {
            return type == TransitionType.Smear || type == TransitionType.Pixelate || type == TransitionType.Slide || type == TransitionType.DoubleSlide || type == TransitionType.Melt || type == TransitionType.Cube || type == TransitionType.Warp || type == TransitionType.Ripple;
        }

        public static bool SupportsPixelization(this TransitionType type) {
            return type == TransitionType.Burn || type == TransitionType.BurnSquare || type == TransitionType.CircularWipe || type == TransitionType.CrossWipe || type == TransitionType.DoubleWipe || type == TransitionType.Fade || type == TransitionType.Melt || type == TransitionType.Screen || type == TransitionType.SeaWaves || type == TransitionType.Shape || type == TransitionType.Splash || type == TransitionType.Wipe;
        }

...
- Added Tiles Progressive effect
- Added Warp effect
- Added Ripple effect

4.7
- Added Randomize option to profile
- Effects with centers will now follow the "Autofollow" object when centers count = 1

4.6
- New transition effect: Circles
- Some logic now runs in LateUpdate to hekp syncing with camera movement
- Improved Tiles transition effect

4.5
- Added "Pixelization" option to some effects
- Smoother Shape transition effect

4.4
- Added new demo scene "Code Controlled Transition"

4.3
- Added "Keep Second Camera Active" option
- Added compatibility with Timeline animation

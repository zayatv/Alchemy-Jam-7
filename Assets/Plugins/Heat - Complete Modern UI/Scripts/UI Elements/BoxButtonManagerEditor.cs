...
namespace Michsky.UI.Heat
{
    ...
    public class BoxButtonManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var buttonCG = serializedObject.FindProperty("buttonCG");
            ...
            var disabledOpacity = serializedObject.FindProperty("disabledOpacity");
            ...
            switch (buttonTarget.latestTabIndex)
            {
                ...
                case 1:
                    ...
                    HeatUIEditorHandler.DrawProperty(buttonCG, customSkin, "Button CG");
                    break;

                case 2:
                    HeatUIEditorHandler.DrawHeader(customSkin, "Options Header", 6);
                    HeatUIEditorHandler.DrawProperty(disabledOpacity, customSkin, "Disabled Opacity");
